    ...
    def train_model(self, data_loader, epoch):
        ...
        for e in range(epoch):
            ...
            for data in data_loader:
                ...
                h, q_mask, u_mask, label = [d.cuda() for d in data]
                log_prob = self.net(h, q_mask, u_mask, att2=True)  # seq_len, batch, n_classes
            ...
            print('epoch {} avg_loss {} avg_accuracy {} avg_fscore {}'.format(e, avg_loss, avg_accuracy, avg_fscore))
